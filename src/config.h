...
#define FW_VERSION     "0.5.22-M5.22"
#define FW_BUILD_DATE  __DATE__

// -----------------------------------------------------------------------------
// 2. Display-Farben (RGB565, 16-bit)
// -----------------------------------------------------------------------------
#define COLOR_BG              0x0000u   // Schwarz (Hintergrund)
#define COLOR_FG              0xFFFFu   // Weiß  (Standardtext)
#define COLOR_ACCENT_GREEN    0x07E0u   // Grün  (Ampel grün)
#define COLOR_ACCENT_AMBER    0xFD20u   // Orange (Ampel gelb)
#define COLOR_ACCENT_RED      0xF800u   // Rot   (Ampel rot)
#define COLOR_TITLE_BG        0x001Fu   // Dunkelblau (Header)
#define COLOR_TITLE_FG        0xFFFFu   // Weiß (Headertext)
#define COLOR_LIST_DIVIDER    0x4208u   // Dunkelgrau (dezente Trennlinien)
#define COLOR_LIST_BG_SEL     0x2945u   // Mittelblau (selektierte Zeile)
#define COLOR_BTN_BG          0x2945u   // Mittelblau (Footer-Button-Hintergrund)
#define COLOR_BTN_FG          0xFFFFu   // Weiß (Footer-Button-Text)
#define COLOR_BTN_DISABLED    0x4208u   // Grau (Footer-Button inaktiv)
#define COLOR_DETAIL_LABEL    0xC618u   // Hellgrau (Detail-Feld-Label)
#define COLOR_DETAIL_VALUE    0xFFFFu   // Weiß     (Detail-Feld-Value)
#define COLOR_DETAIL_BOX_BG   0x0841u   // Sehr dunkles Blau (Detail-Wert-Box)
...
#define COLOR_GRAPH_LINE_OWN  0x07FFu   // Cyan    (gewähltes/eigenes Netz, immer Index 0)
#define COLOR_GRAPH_LINE_1    0x07E0u   // Grün    (stärkstes Vergleichsnetz)
#define COLOR_GRAPH_LINE_2    0xFD20u   // Orange  (2.-stärkstes Vergleichsnetz)
#define COLOR_GRAPH_LINE_3    0xF800u   // Rot     (3.-stärkstes Vergleichsnetz)
#define COLOR_GRAPH_LINE_4    0x001Fu   // Blau    (Reserve, falls WIFI_GRAPH_TOP_N erhöht wird)
#define COLOR_GRAPH_LINE_5    0xF81Fu   // Magenta (Reserve, falls WIFI_GRAPH_TOP_N erhöht wird)
#define COLOR_GRAPH_GRID      0x4208u   // Dunkelgrau (Gitternetz)
#define COLOR_GRAPH_AXIS      0xC618u   // Hellgrau  (Achsen-Labels)
